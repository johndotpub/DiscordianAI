...
- **Optimized Entity Detection**: `ENTITY_DETECTION_MIN_WORDS=10` is parsed into config and available for routing; note that the current routing implementation does not yet consult this value at runtime.
